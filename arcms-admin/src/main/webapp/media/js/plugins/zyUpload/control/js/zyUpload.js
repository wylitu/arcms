...
//					html += '</form>';
		            ...
		            html += '			<div class="status_bar">';
		            html += '				<div id="status_info" class="info">选中0张文件，共0B，请选择不超过5张图片</div>';
		            html += '				<div class="btns">';
		            html += '					<input id="fileImage" type="file" size="30" name="fileselect[]" '+multiple+'>';
				    ...
				    html += '							<img class="upload_image" src='+ baseUrl +  'media/js/plugins/zyUpload/control/images/add_img.png style="width:expression(this.width > '+imgWidth+' ? '+imgWidth+'px : this.width)" />';
				    html += '						</div>';
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
			...
			this.funSetStatusInfo = function(files){
				...
				// 设置内容
				$("#status_info").html("选中"+num+"张文件，共"+size+"，请选择不超过5张图片");
			};
