    ...
    var O = function (h) {
        ...
        function tb(a) {
            ...
            e.bSort && (h.each(p, function (a, b) {
                if("id"!=k.columns[b.col].data){
                    var name=k.columns[b.col].data;
                    var nameNew='';
                    for(var i = 0; i < name.length; i ++){
                        if(name.charCodeAt(i) >= 65 && name.charCodeAt(i) <= 90){
                            nameNew+="_"+name.charAt(i).toLocaleLowerCase();
                            continue;
                        }
                        nameNew+=name.charAt(i);
                    }
                    k.sortColumn=nameNew;
                    k.sortDir=b.dir;
                    k.sortContent=" "+nameNew+"  "+b.dir+" ";
                }
                k.order.push({
                    column: b.col,
                    dir: b.dir
