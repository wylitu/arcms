 ...
 *  @date 2015/4/10 0:37  
 */
public class SMSClientE {

    public static String softwareSerialNo = "6SDK-EMY-6688-JCTNM";// 软件序列号,请通过亿美销售人员获取
    public static String key = "suniusoft";// 序列号首次激活时自己设定
    public static String password = "514711";// 密码,请通过亿美销售人员获取
    ...
    public static void testSendSMS() {
        try {
            int i = SingletonClient.getClient().sendSMS(new String[] { "18057138887",""}, "亲爱的crm客户，您好！关注公众号数粉科技，您可以收到红包！【数粉科技crm】", "test",5);// 带扩展码
    ...
    public static void testSendScheduledSMS() {
        try {
            int i = SingletonClient.getClient().sendScheduledSMSEx(new String[] { "18057138887" },
    ...
    public static void testSendSMSAddMessageId() {
        try {
            int i = SingletonClient.getClient().sendSMSEx("",new String[] { "18057138887" }, "带有信息ID的短信", "", "GBK", 5, 123456789);
            System.out.println("testsSendScheduledSMS=====" + i);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void testRegistDetailInfo() {
        try {
            ...
            int a = SingletonClient.getClient().registDetailInfo("数粉网络科技", "郦土", "18057138887",
                    "18057138887", "litu@shufensoft.com", "18057138887", "杭州西湖区", "313000");
