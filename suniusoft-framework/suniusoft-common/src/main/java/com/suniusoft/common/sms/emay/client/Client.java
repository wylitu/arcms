...
import com.suniusoft.common.sms.emay.cn.b2m.eucp.sdkhttp.SDKServiceBindingStub;
import com.suniusoft.common.sms.emay.cn.b2m.eucp.sdkhttp.SDKServiceLocator;
...
public class Client {
    ...
    public int sendSMSEx(String sendTime, String[] mobiles, String smsContent, String addSerial, String srcCharset, int smsPriority, long smsID)
            throws RemoteException {
        int value = -1;
        value = binding.sendSMS(softwareSerialNo, key, sendTime, mobiles, smsContent, addSerial, srcCharset, smsPriority, smsID);
        return value;
    }
