...
public class PropertyReader {
    ...
    private static String DEFAULT_CONF_PATH = "/config.properties";
    ...
    public final static String getValue(String key) {
        Properties ppts = getProperties(DEFAULT_CONF_PATH);
    ...
    public static void main(String[] args) {
        ...
        String v_ = PropertyReader.getValue("jdbc.password");
        System.out.print(v_);
        _log.info("value1 = " + v_);
