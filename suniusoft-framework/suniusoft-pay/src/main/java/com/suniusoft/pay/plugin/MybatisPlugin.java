package com.suniusoft.pay.plugin;
...
public class MybatisPlugin extends PluginAdapter {
    ...
    private void generateSetExpression(XmlElement element, IntrospectedTable introspectedTable) {
        ...
        if (CollectionUtils.isEmpty(baseColumns) || isOpenExpression == false) {
            return;
        }
    ...
    private void generateToString(IntrospectedTable introspectedTable, TopLevelClass topLevelClass) {
        ...
        topLevelClass.addImportedType(new FullyQualifiedJavaType("com.suniusoft.common.annotation.Domain"));
            ...
            if (f != null) {
                ...
                if (column.getRemarks() != null) {
                    ...
                    if (column.getRemarks().indexOf("@BizId") != -1 || column.getRemarks().indexOf("BizId") != -1
                        ...
                        topLevelClass.addImportedType(new FullyQualifiedJavaType("com.suniusoft.common.annotation.BizId"));
                    }

                }
                //if ("id".equalsIgnoreCase(column.getActualColumnName())) {
                //    f.addAnnotation("@Id");
                //    topLevelClass.addImportedType(new FullyQualifiedJavaType("com.shufensoft.crm.biz.annotation.Id"));
                // }
